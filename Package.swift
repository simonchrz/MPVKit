...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.4/Libmpv.xcframework.zip",
            checksum: "888747db356b85cfb76ca3691d7494c72a0b1976e1100c7782de1a91875d31bf"
        ),
