...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-renderpl.64/Libkkrender.xcframework.zip",
            checksum: "d1bd7576be2b78820652f988449ac58a6a56a4ea741039ab3be9486d4ae20b65"
        ),
    ]
)
