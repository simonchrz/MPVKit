...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            checksum: "84cc8e5e9ef5463e37b32346feb8bbf7eea0474599973d223274b912b632f2ae"
        ),
        .binaryTarget(
            name: "Libavcodec-GPL",
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.16/Libmpv.xcframework.zip",
            checksum: "84cc8e5e9ef5463e37b32346feb8bbf7eea0474599973d223274b912b632f2ae"
        ),
