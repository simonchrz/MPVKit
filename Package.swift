...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.10/Libmpv.xcframework.zip",
            checksum: "de9eee0214095fb8d2e91605516a6477315839161cf19401625654e0434f25f9"
        ),
