...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-master-n8.1-ios-metal.41/Libmpv.xcframework.zip",
            checksum: "5e336a1203b3604e46b9393affcf8f9c28b6db994436d775da2b088171b80bfd"
        ),
