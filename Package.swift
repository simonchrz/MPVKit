...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-master-n8.1-ios-metal.49-ubo-zeroinit/Libmpv.xcframework.zip",
            checksum: "100087677a0303e270b62d834b8d09bc04511324d866b27a239b0ccb3c4cb072"
        ),
