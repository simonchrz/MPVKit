...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.11/Libmpv.xcframework.zip",
            checksum: "f5aabebf2bcf4f21323b5f37084fd4d2eca52e47a86a63e39d5bdc8bfbb1741e"
        ),
