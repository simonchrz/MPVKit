...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-master-n8.1-ios-metal.60k-mat3-expansion/Libmpv.xcframework.zip",
            checksum: "cab762d54040d7ec5115a1dadab63be0e928ba380c7722f604beba4c99967556"
        ),
