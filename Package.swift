...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-master-n8.1-ios-metal.63-passgraph/Libmpv.xcframework.zip",
            checksum: "dc3390168e8a3fd3bf1f1e7be6c1c84867158d782e36b09aaa54dd2558fc1cad"
        ),
