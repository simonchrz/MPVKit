...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-renderpl.66/Libkkrender.xcframework.zip",
            checksum: "ded7567321195a3b8863ac30e45a5c60a87c72e2705a4464df3eb847bd2ca683"
        ),
    ]
)
