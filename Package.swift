...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.7/Libmpv.xcframework.zip",
            checksum: "1f7294756845052b8b6d56b4e3acdcb409ccc08219161a2f06143637423d9d4e"
        ),
