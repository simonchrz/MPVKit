...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-master-n8.1-ios-metal.43/Libmpv.xcframework.zip",
            checksum: "35c0cb031a239d2fc95cac3a6a7df6e79dec68ba517a72417104ce2f3131539f"
        ),
