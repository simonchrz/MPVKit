...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.29/Libmpv.xcframework.zip",
            checksum: "5859a089e72e2f88ed9d4a8ab246c8820b0ccfd146e36855bec0feaca3380e6a"
        ),
