...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.27/Libmpv.xcframework.zip",
            checksum: "8340d67da1fe6c51e54d1df3637953ee3ae3d4e2b6d1c098a05f2d7f2c643a2e"
        ),
