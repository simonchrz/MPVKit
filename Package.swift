...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.22/Libmpv.xcframework.zip",
            checksum: "480424be30a9bcf5f79039625acdaddf416fe7b7e89906d33074efe84449d9a6"
        ),
