...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-renderpl.63/Libkkrender.xcframework.zip",
            checksum: "5c4a740c52ac38ec103987b2f1575581c12f4ed2e58b27208e38c42717e77813"
        ),
    ]
)
