...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-renderpl.2/Libplacebo.xcframework.zip",
            checksum: "a8c01bd98fc2b290bbb62d345cd0940e6fa4fd73a32c20ce6304d3930780fe03"
        ),
