...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.21/Libmpv.xcframework.zip",
            checksum: "0acc473bf2e4b5b03669cff7e7f969585c4bbe04d04adbbd7cb1ffbcfce11f47"
        ),
