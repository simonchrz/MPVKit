...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.8/Libmpv.xcframework.zip",
            checksum: "f699ddd40d30d82587fb8d2b4aa0483c87aed58f13c0342a4d5f7b6fdcd79751"
        ),
