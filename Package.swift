...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-master-n8.1-ios-metal.64-knowngood-ab/Libmpv.xcframework.zip",
            checksum: "a83f37aa62e17f4125a3dfeb64f39965d5efc8bb4ea40439fdfda5de96fcbd79"
        ),
