...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-master-n8.1-ios-metal.50-shader-dump/Libmpv.xcframework.zip",
            checksum: "0983b885226b41f0fcc3421997740f14789f1be78cf72c66bd1a9d5b2803533e"
        ),
