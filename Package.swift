...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-renderpl.7/Libmpv.xcframework.zip",
            checksum: "2b2835de8ef1c30d9c14cce3661ed2118c988a9ca53dd6efadf244dd2b8e9010"
        ),
