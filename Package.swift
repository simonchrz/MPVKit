...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-master-n8.1-ios-metal.42/Libmpv.xcframework.zip",
            checksum: "6c27d36697e1c29d89791beb15024db52cbe865df9ee3a2b81194383d4a434c3"
        ),
