...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.14/Libmpv.xcframework.zip",
            checksum: "fa9c7f8021fa009ab4b417cf3abf9a6099806a7e793e560d998a7645cba727dc"
        ),
