...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-master-n8.1-ios-metal.48-msl-dump/Libmpv.xcframework.zip",
            checksum: "7a9860e0d4e044c36e46a41229cea9dec8111bcc83454481c9ebfb6d0c13bd3b"
        ),
