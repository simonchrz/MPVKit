...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-master-n8.1-ios-metal.44/Libmpv.xcframework.zip",
            checksum: "40b909bcfe07a4a5866830573ffdd403867417e6439f016463871ab33a6ea36a"
        ),
