...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-master-n8.1-ios-metal.46/Libmpv.xcframework.zip",
            checksum: "8da17b978a97c1b1aa8b8fc33e7ee741143186c3a066dcc71e9524c424d42413"
        ),
