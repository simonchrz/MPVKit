...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.1/Libmpv.xcframework.zip",
            checksum: "08cd7f98052c670f18713588d6ea70246f6ace74cc61f7166355218e66b24302"
        ),
