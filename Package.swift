...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-master-n8.1-ios-metal.51-shader-dump-fix/Libmpv.xcframework.zip",
            checksum: "4c149b7f991776f5fb34eb6dc6c4cade5a66a5c77e22a1c82613a4e5f6b5e78d"
        ),
