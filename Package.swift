...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-renderpl.62/Libkkrender.xcframework.zip",
            checksum: "4f85f176e5d66b6ba877742852d61be0a839c813d87d258b408af1bf169c1f21"
        ),
    ]
)
