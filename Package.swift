...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.31/Libmpv.xcframework.zip",
            checksum: "2757aaa3f39f283a7eced190c202b21f80b111a8648ff423a219bdcda5b0c26e"
        ),
