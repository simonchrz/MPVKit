...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-master-n8.1-ios-metal.60i-pipeline-trace/Libmpv.xcframework.zip",
            checksum: "5e6f981d186cbadbeb0eff70bf4576f2f097fb91e89c1deaf809edf037f63caf"
        ),
