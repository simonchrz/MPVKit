...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.26/Libmpv.xcframework.zip",
            checksum: "4597806859e33df03bc68dc3296f7f48cc47fadadb31161876b12de5e8598e44"
        ),
