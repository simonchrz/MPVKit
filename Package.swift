...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-renderpl.68/Libkkrender.xcframework.zip",
            checksum: "9700cddc728f41bb716564764235998f27e24bb8ffbf347317207c78a19ed5f2"
        ),
    ]
)
