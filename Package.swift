...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.28/Libmpv.xcframework.zip",
            checksum: "8283760a3ca3c05971ad2090057973b577764535f255666100e30756ecfdf968"
        ),
