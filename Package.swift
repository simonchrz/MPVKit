...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-master-n8.1-ios-metal.56-aligned-bpr-fix/Libmpv.xcframework.zip",
            checksum: "ffbc8d0d7d436cb89e87d907a843cb48ba496ab639c69a9130fb19ee9732ca4a"
        ),
