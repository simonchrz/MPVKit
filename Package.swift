...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.18/Libmpv.xcframework.zip",
            checksum: "4e6bac8edb96faacd3493cfb4058e00236d9768bbb011ddf6b4282a8a4991583"
        ),
