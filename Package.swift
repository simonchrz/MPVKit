...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-n8.1-ios-metal.15/Libmpv.xcframework.zip",
            checksum: "f6c7eb14dd67c3a7ce7318345fc6d74feb096e690df96086b86aeaf6335043a7"
        ),
