...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-renderpl.65/Libkkrender.xcframework.zip",
            checksum: "48ce1ba895ab5d2a3c817ca475473b6a00b57ec975e3d20559998f1d9cc5e371"
        ),
    ]
)
