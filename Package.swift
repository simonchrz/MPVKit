...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/simonchrz/MPVKit/releases/download/0.41.0-master-n8.1-ios-metal.52-runtime-instr/Libmpv.xcframework.zip",
            checksum: "6574c09b2871b7d568aad6818e82bdac3ae8a83008cb18ee659c436ccf270a0a"
        ),
